    ...
    <section className='container mx-auto py-10 px-4'>
        ...
        <div className='grid grid-cols-1 gap-4'>
            ...
            className='relative group'>
                ...
                <Image className='' src='/../public/images/pdao-web.jpg' alt='/' width='1300' height='50'/>
            ...
            <div className='grid grid-cols-2 gap-4'>
                ...
                className='relative group'>
                    ...
                    <Image className='' src='/../public/images/pdao-dashboard.jpg' alt='/' width='1300' height='50'/>
                ...
                className='relative group'>
                    ...
                    <Image className='' src='/../public/images/pos-web.jpg' alt='/' width='1300' height='50'/>
            ...
            whileInView={'show'}
            viewport={{ once: false, amount: 0.7 }}
            className='flex flex-col items-center justify-center mt-8 text-[30px] sm:text-[40px]'>
