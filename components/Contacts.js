    ...
    <section className='container mx-auto py-10 px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-1 gap-6'>
            ...
            className='shadow-lg flex flex-col gap-4 px-8 py-10 bg-[#5050e6] text-white rounded-[10px]'>
                ...
                <h2 className='font-medium mb-10 text-[40px] sm:text-[50px] md:text-[60px]'>Collaborate with me</h2>
                
                <h2 className='font-medium -mt-5 text-[15px] md:text-[20px]'>
                ...
                <div className='flex flex-col-1 gap-4'>
                    <div className=''>
                        <AiOutlineMail className='text-[23px] md:text-[28px]'/>
                        <IoLocationOutline className='text-[23px] md:text-[28px]'/>
                        <RiContactsBook2Line className='text-[23px] md:text-[28px] md:mb-1'/>
                        <FaLinkedinIn className='text-[23px] md:text-[28px]'/>
                    </div>

                    <div className=''>
                        <h2 className='font-medium text-[15px] md:text-[20px]'>dietherddeluna@gmail.com</h2>
                        <h2 className='font-medium text-[15px] md:text-[20px]'>Santa Cruz, Laguna</h2>
                        <h2 className='font-medium text-[15px] md:text-[20px]'>+63 (938) 788 0906</h2>
                        <h2 className='font-medium text-[15px] md:text-[20px]'>www.linkedin.com/in/diether-de-luna</h2>
                    </div>
                </div>
