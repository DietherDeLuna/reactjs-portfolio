...
const Skills = () => {
  return (
    <section className='container mx-auto py-10 px-4'>
        ...
        whileInView={'show'}
        viewport={{ once: true, amount: 0.7 }}
        className='text-gray-600 -mt-10 mb-10 text-[20px]'>
        ...
        className='grid grid-cols-1 md:grid-cols-3 gap-6 text-[20px] font-medium'>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/react-.png' alt='/' width='64' height='64'/>
                    </div>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/html5.png' alt='/' width='64' height='64'/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <h3>HTML</h3>
                    </div>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/js.png' alt='/' width='64' height='64'/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <h3>JavaScript</h3>
                    </div>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/php-.png' alt='/' width='64' height='64'/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <h3>PHP</h3>
                    </div>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/mysql-.png' alt='/' width='64' height='64'/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <h3>MySQL</h3>
                    </div>
            ...
            <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
                <div className='grid grid-cols-2 gap-4 justitfy-center items-center'>
                    <div className='m-auto'>
                        <Image className='cursor-pointer' src='/../public/images/cs.png' alt='/' width='64' height='64'/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <h3>CSS</h3>
                    </div>
