        ...
        <div className='text-center'>
            ...
            <div className='bg-[#5050e6] h-[2px] w-[400px] sm:w-[500px] md:w-[600px] lg:w-[800px]
             ...
             <div className='flex items-center justify-between mt-5'>
              <p className='font-medium text-gray-500 uppercase text-[20px]'>Follow Me!</p>
              <p className='font-medium text-gray-500 uppercase text-[20px]'>&copy; Diether De Luna 2023</p>
             </div>
